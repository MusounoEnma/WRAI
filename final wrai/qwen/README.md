# 🧠 WRAI-X (0.6B) Model Weights

Folder ini menyimpan bobot model **WRAI-X (0.6B)** hasil transplantasi:

| Nama File | Ukuran | Format | Deskripsi |
| :--- | :--- | :--- | :--- |
| `wrai_x_vocab.bin` | **1.52 MB** | Binary BPE Table | Sudah disertakan langsung di repositori Git. |
| `wrai_x_06b_int8.bin` | **1.35 GB** | INT8 Row-wise (mmap) | Biner terkuantisasi untuk eksekusi di Native C Engine. |
| `wrai_x_06b_transplanted.pt` | **1.66 GB** | PyTorch Checkpoint | Bobot asli untuk fine-tuning lanjutan di Google Colab. |

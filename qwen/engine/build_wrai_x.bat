@echo off
if exist "%~dp0..\..\archive\tools\w64devkit\bin\gcc.exe" set "PATH=%~dp0..\..\archive\tools\w64devkit\bin;%PATH%"
if exist "%~dp0..\..\tools\w64devkit\bin\gcc.exe" set "PATH=%~dp0..\..\tools\w64devkit\bin;%PATH%"
cd /d "%~dp0"

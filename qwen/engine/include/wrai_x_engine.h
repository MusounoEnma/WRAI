...
#define WRAI_X_VERSION         171         /* v17.1 (WRAI-X with RetNet GroupNorm) */
...
typedef struct {
    ...
    /* RetNet GroupNorm Affine Parameters */
    const float*  gn_m_w;        /* [2048] */
    const float*  gn_m_b;        /* [2048] */
    const float*  gn_r_w;        /* [2048] */
    const float*  gn_r_b;        /* [2048] */
